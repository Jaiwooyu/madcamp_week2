     ...
     <div className="record-container">
       ...
       {currentStep === 0 && (
         <div className="record-form">
           ...
           <input type="text" placeholder="출생 (yyyy.mm.dd)" value={formData.birthDate} 
             onChange={(e) => handleInputChange(e, 'birthDate')} />
           {errors.birthDate && <div className="error-message">{errors.birthDate}</div>}

           <input type="text" placeholder="종" value={formData.species} 
             onChange={(e) => handleInputChange(e, 'species')} />
           {errors.species && <div className="error-message">{errors.species}</div>}

           <input type="text" placeholder="성별" value={formData.gender} 
       ...
       {currentStep === 1 && (
         <div className="record-form">
           <textarea placeholder="성격" value={formData.personality}
             onChange={(e) => handleInputChange(e, 'personality')} />
           <textarea placeholder="특징" value={formData.traits}
       ...
       {currentStep === 2 && (
         <div className="record-form">
           <textarea placeholder="행복했던 기억" value={formData.happyMemory}
             onChange={(e) => handleInputChange(e, 'happyMemory')} />
           <textarea placeholder="사고뭉치 에피소드" value={formData.mishap}
       ...
       {currentStep === 3 && (
         <div className="record-form">
           <textarea placeholder="장점" value={formData.strengths}
             onChange={(e) => handleInputChange(e, 'strengths')} />
           <textarea placeholder="단점" value={formData.weaknesses}
       ...
       <div className="button-group">
         {currentStep > 0 && (
           <button onClick={handlePrev} className="prev-button">이전으로</button>
         )}
